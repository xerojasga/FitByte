 ...
 */
public class ConsumptionCreateCoach extends javax.swing.JFrame {
    private static User current_user;
    private int cal = 0;
    /**
     * Creates new form Coach
     */
    public ConsumptionCreateCoach(User user) {
        initComponents();
        current_user = user;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsumptionCreateCoach.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsumptionCreateCoach(current_user).setVisible(true);
            }
        });
    }
